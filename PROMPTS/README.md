# 📌 Directorio `PROMPTS` — Plantillas y ejemplos de prompts

Este directorio contiene **plantillas, patrones y ejemplos** para ayudarte a formular mejores prompts para IA generativa. La idea es tener un lugar único donde puedas consultar:

- Cómo estructurar un prompt efectivo (rol, contexto, formato, restricciones).
- Prompts genéricos listos para copiar y pegar.
- Ejemplos prácticos clasificados por uso.
...
- Añade nuevas plantillas o mejoras en `generales.md`.
- Crea nuevos archivos en `ejemplos/` con casos de uso reales.
- Si detectas archivos que no se usan, sugiérelos como limpieza o transformación.

---

*Este README está pensado para ayudarte a usar y ampliar el repertorio de prompts del proyecto.*
